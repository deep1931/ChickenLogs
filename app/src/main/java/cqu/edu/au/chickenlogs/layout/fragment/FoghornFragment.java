 ...
 */
public class FoghornFragment extends Fragment {
    ...
    public static FoghornFragment newInstance() {
        return new FoghornFragment();
    }

    public FoghornFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_foghorn, container, false);
    ...
    private void init() {
        ...
        btnSaveLog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (validate()) {
                    if (dbAdapter.insertLogs(id, HomeFragment.CHICKEN_TYPE_FOGHORN, weight, eggs, grain, water) < 0) {
        ...
        btnShowLog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("type", HomeFragment.CHICKEN_TYPE_FOGHORN);
