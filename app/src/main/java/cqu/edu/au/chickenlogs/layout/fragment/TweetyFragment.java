...
public class TweetyFragment extends Fragment {
    ...
    public static TweetyFragment newInstance() {
        return new TweetyFragment();
    }
    ...
    private void init() {
        ...
        btnSaveLog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (validate()) {
                    if (dbAdapter.insertLogs(id, HomeFragment.CHICKEN_TYPE_TWEETY, weight, eggs, grain, water) < 0) {
        ...
        btnShowLog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("type", HomeFragment.CHICKEN_TYPE_TWEETY);
