 ...
 */
public class HawkFragment extends Fragment {
    ...
    public static HawkFragment newInstance() {
        return new HawkFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_hawk, container, false);
    ...
    private void init() {
        ...
        btnSaveLog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (validate()) {
                    if (dbAdapter.insertLogs(id, HomeFragment.CHICKEN_TYPE_HAWK, weight, eggs, grain, water) < 0) {
        ...
        btnShowLog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("type", HomeFragment.CHICKEN_TYPE_HAWK);
